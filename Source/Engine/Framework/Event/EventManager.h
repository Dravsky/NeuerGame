...
#define EVENT_SUBSCRIBE(id, function)	lola::EventManager::Instance().Subscribe(id, this, std::bind(&function, this, std::placeholders::_1));
#define EVENT_UNSUBSCRIBE(id)			lola::EventManager::Instance().Unsubscribe(id, this);
#define EVENT_DISPATCH(id, data) lola::EventManager::Instance().DispatchEvent(id, data)
