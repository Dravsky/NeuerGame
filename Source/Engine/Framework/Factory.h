...
#define CREATE_CLASS(classname) lola::Factory::Instance().Create<lola::classname>(#classname);
#define CREATE_CLASS_BASE(classbase, classname) lola::Factory::Instance().Create<lola::classbase>(classname);
#define INSTANTIATE(classbase, classname) lola::Factory::Instance().Create<lola::classbase>(classname);
